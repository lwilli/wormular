...
10. **1v1 battle** — dual-worm sim (opposite starts, 2 apples, first death loses); local split-input (left/right touch halves + Space/W); online lockstep via Durable Objects. **Done:** local + online; `MatchRoom` DO; finish-before-close; view mirror; match countdown; input pipelining; mobile split-touch zones.
