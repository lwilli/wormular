...
**Playing:** no HUD except a small current score (Local 1v1: dual mirrored seat chrome — orange top rotated 180°, teal bottom upright — plus soft zone tints). Solo: finger/click anywhere is thrust. Local: top half thrusts orange, bottom half thrusts teal (multi-touch); Space / W still work on keyboard. On death in v1: write high score if needed and return to the title overlay immediately. No freeze, shake, flash, or sound until the juice phase.
