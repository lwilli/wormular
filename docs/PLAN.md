...
11. **Visit counter** — cookieless first-party `POST /visit` + `GET /stats` on the same Worker/D1 (aggregate count only). **Done:** ADR [adr/0003-cookieless-visit-analytics.md](adr/0003-cookieless-visit-analytics.md).
